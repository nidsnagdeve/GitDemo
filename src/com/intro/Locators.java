...
public class Locators {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//driver.findElement(By.xpath("//input[@placeholder='Phone Number']")).sendKeys("8756432123");
		//CSSSelector
		...
		//locating with parent-child relationship
		driver.findElement(By.xpath("//form/input[3]")).sendKeys("7456345678");
